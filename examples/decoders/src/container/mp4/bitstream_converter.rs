// Copied from: https://github.com/ralfbiedert/openh264-rs/blob/master/openh264/examples/mp4/mp4_bitstream_converter.rs
...
#[derive(Error, Debug)]
pub enum Error {
    #[error("Track does not contain AVC1 config")]
    MissingAVC1Config,
}
...
impl Mp4BitstreamConverter {
    ...
    /// The track must contain an AVC1 configuration.
    pub fn for_mp4_track(track: &Mp4Track) -> Result<Self, Error> {
